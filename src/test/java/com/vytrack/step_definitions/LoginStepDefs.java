...
public class LoginStepDefs {
    ...
    public void the_user_enters_the_sales_manager_information() throws InterruptedException {
        Thread.sleep(3000);
        System.out.println("i enter sales manager username and password and click login button");
    }

    @When("the user enters the store manager information")
    public void the_user_enters_the_store_manager_information() throws InterruptedException {
        Thread.sleep(3000);
        System.out.println("i enter store manager username and password and click login button");
    }
